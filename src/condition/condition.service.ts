...
export class ConditionService {
    ...
    async createFeedingCondition(dto: CreateFeedingConditionDto, userId: string): Promise<ConditionData> {
        try {
            ...
            let message;
            let sensorName = dto.sensor == 'WATER_TEMPERATURE' ? '수온' : dto.sensor;
            ...
            if (dto.condition == 'GTE') {
                message = `${tank.name}의 ${sensorName}(이)가 ${dto.value} 이상입니다. ${dto.recommendation} 투여가 권장됩니다.`
            } else if (dto.condition == 'LTE') {
                message = `${tank.name}의 ${sensorName}(이)가 ${dto.value} 이하입니다. ${dto.recommendation} 투여가 권장됩니다.`
            } else if (dto.condition == 'GT') {
                message = `${tank.name}의 ${sensorName}(이)가 ${dto.value}보다 큽니다. ${dto.recommendation} 투여가 권장됩니다.`
            } else if (dto.condition == 'LT') {
                message = `${tank.name}의 ${sensorName}(이)가 ${dto.value}보다 작습니다. ${dto.recommendation} 투여가 권장됩니다.`
            }
    ...
    async createAlertCondition(dto: AlertConditionDto, userId: string): Promise<ConditionData> {
        try {
            ...
            if (dto.condition == 'GTE') {
                ...
                message = `${tank.name}의 ${sensorName}(이)가 ${dto.value} 이하입니다. 조치가 필요합니다.`
            } else if (dto.condition == 'GT') {
                message = `${tank.name}의 ${sensorName}(이)가 ${dto.value}보다 큽니다. 조치가 필요합니다.`
            } else if (dto.condition == 'LT') {
