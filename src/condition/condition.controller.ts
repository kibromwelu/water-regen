...
export class ConditionController {
    ...
    async createFeedingCondition(@Body() dto: CreateFeedingConditionDto, @CurrentUserId() userId: string): Promise<MessageResponse> {
    ...
    async updateFeedingCondition(@Param('id') id: string, @Body() dto: UpdateFeedingConditionDto, @CurrentUserId() userId: string): Promise<MessageResponse> {
    ...
    @ApiResponse({ status: 201, type: MessageResponse })
    async createAlertCondition(@Body() dto: AlertConditionDto, @CurrentUserId() userId: string) {
    ...
    async updateAlertCondition(@Param('id') id: string, @Body() dto: AlertConditionDto, @CurrentUserId() userId: string) {
